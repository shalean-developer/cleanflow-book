-- =====================================================
-- SIMPLE BOOKING PERMISSIONS FIX
-- =====================================================
-- This is a simplified version that works regardless of your database schema
-- It focuses only on the core issue: allowing users to make multiple bookings
...
-- Only create if profiles table has role column
DO $$
BEGIN
  IF EXISTS (
...
-- =====================================================
-- STEP 4: Fix booking_extras policies (simplified)
-- =====================================================
...
-- Create simple booking_extras policies
...
-- =====================================================
-- STEP 5: Fix payments policies (simplified)
-- =====================================================
...
-- =====================================================
-- STEP 6: Fix profiles policies (simplified)
-- =====================================================
...
-- END OF SCRIPT
-- =====================================================
-- This simplified fix focuses on the core issue:
-- 1. Users can make multiple bookings
-- 2. Each user can only see their own bookings
-- 3. No more "no right to view" errors
-- 4. Works regardless of your specific database schema
